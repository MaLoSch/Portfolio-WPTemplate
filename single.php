		...
		<?php get_header(); ?> <!-- get header.php file -->
            ...
            <div class="main">
			  	<?php if (has_tag('Ongoing')) { ?>
					<h1 class="highlightColor"><?php echo get_the_title(); ?> <span class="light">(ongoing)</span></h1> <!-- get title of page -->
				<?php } else { ?>
				...
				<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
	                ...
	                <div class="project_description">
						...
						<?php if (has_tag('Ongoing')) { ?>
							<p>ongoing</p> <!-- display Work in Progress -->
						<?php } else { ?>
						...
						<ul class="categories_ul">
							<?php exclude_post_categories("40"); ?> <!-- list all categories but exclude cat 19 (Portfolio). See functions.php for more info or visit http://wordpress.stackexchange.com/questions/31181/exclude-categories-from-the-category -->
						</ul>
					</div>
